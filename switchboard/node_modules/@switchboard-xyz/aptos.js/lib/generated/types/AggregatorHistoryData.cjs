...
exports.AggregatorHistoryData = void 0;
...
class AggregatorHistoryData {
    ...
    static fromJSON(obj) {
        return new AggregatorHistoryData({
            ...
            historyWriteIdx: new common_1.BN(obj.historyWriteIdx),
        });
    }
    toMoveStruct() {
        return {
    ...
    static fromMoveStruct(obj) {
        return new AggregatorHistoryData({
            ...
            historyWriteIdx: new common_1.BN(obj.history_write_idx),
        });
    }
}
