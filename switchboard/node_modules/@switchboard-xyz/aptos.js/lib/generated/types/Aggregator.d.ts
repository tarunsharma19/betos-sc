...
export interface IAggregator {
    ...
    jobKeys: Array<AccountAddressInput>;
...
export declare class Aggregator implements IAggregator {
    ...
    readonly jobKeys: Array<AccountAddressInput>;
    ...
    static fromJSON(obj: AggregatorJSON): types.Aggregator;
    toMoveStruct(): AggregatorMoveStruct;
    static fromMoveStruct(obj: AggregatorMoveStruct): types.Aggregator;
}
