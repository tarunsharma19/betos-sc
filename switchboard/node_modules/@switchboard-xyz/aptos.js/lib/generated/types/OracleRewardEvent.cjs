...
class OracleRewardEvent {
    ...
    static fromJSON(obj) {
        return new OracleRewardEvent({
            ...
            oracleAddress: obj.oracleAddress,
    ...
    static fromMoveStruct(obj) {
        return new OracleRewardEvent({
            ...
            oracleAddress: obj.oracle_address,
            amount: new common_1.BN(obj.amount),
            timestamp: new common_1.BN(obj.timestamp),
        });
    }
}
exports.OracleRewardEvent = OracleRewardEvent;
