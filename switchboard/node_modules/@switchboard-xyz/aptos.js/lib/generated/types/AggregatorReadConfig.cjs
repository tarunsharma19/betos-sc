...
class AggregatorReadConfig {
    ...
    static fromJSON(obj) {
        return new AggregatorReadConfig({
            readCharge: new common_1.BN(obj.readCharge),
    ...
    static fromMoveStruct(obj) {
        return new AggregatorReadConfig({
            readCharge: new common_1.BN(obj.read_charge),
...
exports.AggregatorReadConfig = AggregatorReadConfig;
